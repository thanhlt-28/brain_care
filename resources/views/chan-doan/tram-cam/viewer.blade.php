                            ...
                            <div class="header">
                                <div class="row">
                                    <div class="col-md-2 ml-3">
                                        <img src="https://braincare.vn/wp-content/uploads/2021/03/logo-new.png"
                                            width="70px" alt="">
                                    </div>
                                    <div class="col-md-9">
                                    ...
                                    <tr id="row_1">
                                        <td>
                                            <input type="text" data-field-name="name" name="Name[]" id="medicineName"
                                                class="form-control autocomplete_txt" placeholder="Tên thuốc"
                                                autocomplete="off" value="{{old('Name', $pre->Name)}}">
                                            <div id="search-ajax">
                                            </div>
                                        </td>
                                        <td>
                                            <input type="number" min="0" max="10" data-field-name="amount"
                                                name="Amount[]" id="amount_code_" class="form-control autocomplete_txt"
                                                placeholder="Số lượng" autocomplete="off"
                                                value="{{old('Amount', $pre->Amount)}}">
                                        </td>
                                        <td>
                                            <input type="text" data-field-name="treatment" name="Treatment[]"
                                                id="treament_code_" class="form-control autocomplete_txt"
                                                placeholder="Liều lượng(viên)" autocomplete="off"
                                                value="{{old('Treatment', $pre->Treatment)}} viên/ ngày">
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>

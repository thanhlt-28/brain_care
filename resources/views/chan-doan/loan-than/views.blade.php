                        ...
                        <table id="dtStatusSent" class="table table-hover" cellspacing="0" width="100%">
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th>Thuốc</th>
                                    <th>
                                        <a href="{{ route('loan-than.create') }}" class="btn btn-success">Thêm chẩn đoán mới</a>
                                    </th>
                                </tr>
                            </thead>
                            <tbody id="myTable">
                                ...
                                <tr>
                                    ...
                                    <td>{{ $item->result }}</td>
                                    <td> <a href="{{route('loan-than.viewer', $item->id)}}">Đơn thuốc</a></td>
                                    <td>
                                        <a class="btn btn-info" href="{{route('loan-than.index', $item->id)}}">Xem chi tiết</a>
                                        <a class="btn btn-warning" href="{{route('loan-than.destroy', ['id' => $item->id])}}">Xóa</a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>

...
<div class="container-wraper">
    ...
    <script type="text/javascript">
        ...
        function recalcTC() {
            ...
            n = parseInt(document.getElementById('tc02a').innerHTML) + parseInt(document.getElementById('tc03a')
                .innerHTML) + parseInt(document.getElementById('tc04').innerHTML) + parseInt(document.getElementById(
                    'tc05')
                .innerHTML) + parseInt(document.getElementById('tc06').innerHTML) + parseInt(document.getElementById(
                'tc07').innerHTML) + parseInt(document.getElementById('tc08').innerHTML) + parseInt(document
                .getElementById('tc09').innerHTML) + parseInt(document.getElementById('tc11').innerHTML) + parseInt(
                document.getElementById('tc13').innerHTML);
                        ...
                        <table id="dtStatusSent" class="table table-hover" cellspacing="0" width="100%">
                            ...
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th>Thuốc</th>
                                    <th>
                                        <a href="{{ route('nghien-ruou.create') }}" class="btn btn-success">Thêm chẩn
                                            đoán mới</a>
                                    </th>
                            ...
                            <tbody id="myTable">
                                ...
                                <tr>
                                    ...
                                    <td>{{ $item->result }}</td>
                                    <td>
                                        <a href="{{route('nghien-ruou.viewer', $item->id)}}">Đơn thuốc</a>
                                    </td>
                                    <td>
                                        <a class=" btn btn-info" href="{{route('nghien-ruou.index', $item->id)}}">Xem
                                            chi tiết</a>
